...
# Import Data
df = pd.read_csv('parliamentary-constituency-profiles-data.csv', usecols=[ "Parliamentary Constituency", 'Persons-2008',"aged 0-14-2008","aged 15-34-2008","aged 35-54-2008","aged 55-74-2008","aged 75+-2008"])
